...
class App extends Component {
  ...
  redirectToDevPost = event => {
    const url = 'https://hackedbeta2018.devpost.com/';
    window.open(url, '_blank');
  };
        ...
        <Grid 
          ...
          <Grid.Row>
            <Grid.Column textAlign='center'>
              ...
              <Button onClick={this.redirectToDevPost} color='betablue' size='huge' className='homePageButton'>DevPost</Button>
