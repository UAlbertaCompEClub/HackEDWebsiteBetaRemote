...
const scheduleData = [
    ...
    { name: "Git", type: types.workshops, time: "12:00pm", description: "Git Workshop presented by DevFacto" },
    { name: "Bluetooth Low Energy", type: types.workshops, time: "2:00pm", description: "Bluetooth Low Energy Workshop presented by The Pod" },
    { name: "Supper", type: types.food, time: "4:00pm", description: "Hungry? Looks like It's time to fill up on _______!" },
    { name: "Android", type: types.workshops, time: "6:30pm", description: "Android Workshop presented by DevFacto" },
    ...
    { name: "Judging", type: types.general, time: "12:00pm", description: "Judges will be coming around, be on your best sleepy behaviour." },
    { name: "Closing Ceremonies", type: types.general, time: "2:30pm", description: "Woah that was awesome, hey? Ready for HackED?" },
];
